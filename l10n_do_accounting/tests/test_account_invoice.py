...
class AccountInvoiceTests(AccountInvoiceCommon):
    ...
    def test_001_invoice_l10n_latam_sequence_id(self):
        ...
        self.assertEqual(invoice_1_id.l10n_latam_sequence_id.id,
                         self.seq_fiscal)
        ...
        self.assertEqual(invoice_2_id.l10n_latam_sequence_id.id,
                         self.seq_informal)
        ...
        self.assertEqual(invoice_3_id.l10n_latam_sequence_id.id,
        ...
        self.assertEqual(invoice_4_id.l10n_latam_sequence_id.id,
                         self.seq_debit_note)
    ...
    def test_004_onchange_partner_id(self):
        ...
        invoice_id.write({'l10n_latam_document_type_id': False,
                          'partner_id': self.partner_demo_4})
        invoice_id._onchange_partner_id()

        partner_id = self.partner_obj.browse(self.partner_demo_4)
        self.assertEqual(invoice_id.l10n_latam_document_type_id.id,
    ...
    def test_006_invoice_fiscal_type_l10n_do_expense_type(self):
        ...
        self.assertEqual(invoice_id.l10n_do_expense_type,
                         partner_id.l10n_do_expense_type)
    ...
    def test_010_invoice_partner_purchase_fiscal_type_l10n_do_expense_type(self):
        ...
        partner_id.purchase_fiscal_type_id = invoice.l10n_latam_document_type_id and if not
        partner_id.l10n_do_expense_type, partner_id.l10n_do_expense_type = invoice.l10n_do_expense_type
        """
    ...
    def test_013_fiscal_customer_refund_percentage(self):
        ...
        self.assertEqual(credit_note_id.l10n_latam_document_type_id.id,
                         self.fiscal_type_cn)
    ...
    def test_017_fiscal_customer_debit_note_percentage(self):
        ...
        self.assertEqual(debit_note_id.l10n_latam_document_type_id.id,
                         self.fiscal_type_dn)
