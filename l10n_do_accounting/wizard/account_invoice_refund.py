...
class AccountInvoiceRefund(models.TransientModel):
    ...
    def _get_refund_method_selection(self):
        if self._context.get("debit_note"):
            return [
                ("draft_refund", "Create a draft debit note"),
        ...
        for wizard in self:
            if wizard.refund_type == "full_refund":
                return super(
                    ...
                    self.with_context(refund_reference=wizard.refund_reference),
                ...
                # TODO move this to l10n_do_external_validation_ncf
                    ...
                    raise ValidationError(
                        _(
                            ...
                            "yet."
                        ).format(self.refund_reference, self.partner_id.name)
                    )
