...
########################################################################################################################
{
    ...
    'description': """
        Permite la integracion de los numeros de comprbantes fiscales y ajusta la imprecion de ticket para
        estos fines, ademas cuanta con muchas otras funcionalidades que optimizan fa funcionalidad del punto de ventas.
    """,
    ...
    'depends': ['base', 'point_of_sale', 'ncf_manager', 'sale', 'web_editor', "sale_control", "pos_restaurant", 'mrp'],
